...
The next important thing to understand is that the gradation report is a progressive report. What I mean by that is, let's say the lot received was around 6,000 meters. But in the process they found that 1,000 meters were not good, or they've only processed 4,000 meters so far. Then the gradation report should show how much progress has been made on the original lot, and the report itself should only cover the portion of the lot that has actually gone through the process up to whatever stage it's reached.
